...
class GDTExtractor:
    ...
    def extract_dimensional_tolerances(self, text, line_dict):
        """Extract dimensional tolerances (diameter, length) with their tolerance values"""
        dimensional_results = []
        ...
        try:
            ...
            for match in dimensional_size_pattern.finditer(text):
                ...
                dimensional_results.append((
                    ...
                    "",  # No datum for dimensional tolerances
                    location,
                    surface,
                    tolerance_range,
                    upper_limit,
    ...
    def create_control_panel(self):
        ...
        info_label = tk.Label(
            self.mid_frame, 
            text="✨ Extracts: Geometric Tolerances + Dimensional Tolerances (Diameter & Length)", 
            font=("Arial", 9, "italic"), 
            bg="#eef3f7", 
            fg="#008000"
        )
    ...
    def create_status_bar(self):
        ...
        self.status_bar = tk.Label(
            self.root, 
            text="Ready - Enhanced to extract dimensional tolerances", 
            relief=tk.SUNKEN, 
            anchor=tk.W,
            bg="#e9ecef",
            font=("Arial", 9)
    ...
    def upload_and_process(self):
        ...
        self.status_bar.config(text="Processing file... (extracting geometric and dimensional tolerances)")
        self.root.update()
        ...
        try:
            ...
            geometric_count = len([r for r in result_data if not any(symbol in r[0] for symbol in ["⌀ Diameter", "↔"])])
            ...
            self.status_bar.config(text=f"✅ Extracted: {geometric_count} geometric, {dimensional_count} dimensional, {datum_count} datums from {filename}")
    ...
    def clear_output(self):
        ...
        self.status_bar.config(text="Ready - Enhanced to extract dimensional tolerances")
